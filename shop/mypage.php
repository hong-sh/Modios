...
$g5['title'] = $member['mb_name'].'\'s Mypage';
...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
        ...
        <div id="smb_my_act">
            <ul>
                ...
                <li><a href="<?php echo G5_BBS_URL; ?>/memo.php" target="_blank" class="win_memo btn10">쪽지함</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=register_form.php" class="btn10">회원정보수정</a></li>
                <li><a href="<?php echo G5_BBS_URL; ?>/member_confirm.php?url=member_leave.php" onclick="return member_leave();" class="btn10">회원탈퇴</a></li>
            </ul>
        </div>

        <dl>
            <dt>Point</dt>
            <dd><a href="<?php echo G5_BBS_URL; ?>/point.php" target="_blank" class="win_point"><?php echo number_format($member['mb_point']); ?> Point</a></dd>
            <dt>Coupon</dt>
            ...
            <dt id="smb_my_ovaddt" style ="clear: left;">Address</dt>
    ...
    <section id="smb_my_od">
        ...
        <div class="smb_my_more">
            <a href="./orderinquiry.php" class="btn10">more orderlist+</a>
        </div>
    </section>
    <!-- } 최근 주문내역 끝 -->
    ...
    <section id="smb_my_wish">
        ...
        <div class="smb_my_more">
            <a href="./wishlist.php" class="btn10">more wishlist+</a>
        </div>
    </section>
    <!-- } 최근 위시리스트 끝 -->
