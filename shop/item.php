...
$row = sql_fetch($sql);
if ($row['it_id']) {
    $prev_title = 'pre item<span class="sound_only"> '.$row['it_name'].'</span>';
...
$row = sql_fetch($sql);
if ($row['it_id']) {
    $next_title = 'next item<span class="sound_only"> '.$row['it_name'].'</span>';
...
?>
<!--     <ul class="sanchor"> 
        <li><a href="#sit_inf" <?php //if ($anc_id == 'inf') echo 'class="sanchor_on"'; ?>>detail</a></li>
        <li><a href="#sit_use" <?php //if ($anc_id == 'use') echo 'class="sanchor_on"'; ?>>review <span class="item_use_count"><?php //echo $item_use_count; ?></span></a></li>
        <li><a href="#sit_qa" <?php //if ($anc_id == 'qa') echo 'class="sanchor_on"'; ?>>inquire <span class="item_qa_count"><?php //echo $item_qa_count; ?></span></a></li>
        <?php //if ($default['de_baesong_content']) { ?><li><a href="#sit_dvr" <?php //if ($anc_id == 'dvr') echo 'class="sanchor_on"'; ?>>delivery</a></li><?php //} ?>
        <?php //if ($default['de_change_content']) { ?><li><a href="#sit_ex" <?php //if ($anc_id == 'ex') echo 'class="sanchor_on"'; ?>>exchange</a></li><?php //} ?>
        <?php //if($default['de_rel_list_use']) { ?>
        <li><a href="#sit_rel" <?php //if ($anc_id == 'rel') echo 'class="sanchor_on"'; ?>>relate <span class="item_relation_count"><?php //echo $item_relation_count; ?></span></a></li>
        <?php //} ?>
    </ul> -->
<?php
}
