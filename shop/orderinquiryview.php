...
<div id="sod_fin">
    ...
    <section id="sod_fin_list">
        ...
        <div class="tbl_head02 tbl_wrap">
            ...
            <thead>
            <tr>
                <th scope="col" rowspan="2">img</th>
                <th scope="col" colspan="7" id="th_itname">item</th>
            </tr>
            <tr>
                <th scope="col" id="th_itopt">option</th>
                <th scope="col" id="th_itqty">amount</th>
                <th scope="col" id="th_itprice">price</th>
                <th scope="col" id="th_itsum">total</th>
                <th scope="col" id="th_itpt">point</th>
                <th scope="col" id="th_itpt">deliver</th>
                <th scope="col" id="th_itst">state</th>
            </tr>
            </thead>
            <tbody>
            <?php
        ...
        <dl id="sod_bsk_tot">
            <dt class="sod_bsk_dvr">order</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_cart_price']); ?> won</strong></dd>

            <?php if($od['od_cart_coupon'] > 0) { ?>
            <dt class="sod_bsk_dvr">discount</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_cart_coupon']); ?> won</strong></dd>
            <?php } ?>

            <?php if($od['od_coupon'] > 0) { ?>
            <dt class="sod_bsk_dvr">discount</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_coupon']); ?> won</strong></dd>
            <?php } ?>

            <?php if ($od['od_send_cost'] > 0) { ?>
            <dt class="sod_bsk_dvr">delivery</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_send_cost']); ?> won</strong></dd>
            <?php } ?>

            <?php if($od['od_send_coupon'] > 0) { ?>
            <dt class="sod_bsk_dvr">discount</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_send_coupon']); ?> won</strong></dd>
            <?php } ?>

            <?php if ($od['od_send_cost2'] > 0) { ?>
            <dt class="sod_bsk_dvr">add delivery</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_send_cost2']); ?> won</strong></dd>
            <?php } ?>

            <?php if ($od['od_cancel_price'] > 0) { ?>
            <dt class="sod_bsk_dvr">cancel</dt>
            <dd class="sod_bsk_dvr"><strong><?php echo number_format($od['od_cancel_price']); ?> won</strong></dd>
            <?php } ?>

            <dt class="sod_bsk_cnt">total price</dt>
            <dd class="sod_bsk_cnt"><strong><?php echo number_format($tot_price); ?> won</strong></dd>

            <dt class="sod_bsk_point">price</dt>
