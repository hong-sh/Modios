...
<div id="sod_bsk">
    ...
    <dl id="sod_bsk_tot">
        ...
        <dt class="sod_bsk_cnt">total price / point</dt>
        <dd class="sod_bsk_cnt"><strong><?php echo number_format($tot_price); ?> won / <?php echo number_format($tot_point); ?> point</strong></dd>
        <?php } ?>
