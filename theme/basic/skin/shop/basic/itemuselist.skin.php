...
<div id="sps_sch">
   <a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>">All Review</a>
...
<div id="sps">
    ...
    <li>
        ...
        <section class="sps_section">
            ...
            <div class="sps_con_btn" style = "float:right;"><button class="sps_con_<?php echo $i; ?>">view</button></div>
        </section>
