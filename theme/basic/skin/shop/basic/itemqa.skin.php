...
<div id="sit_qa_wbtn">
    ...
    <a href="<?php echo $itemqa_form; ?>" class="btn02 itemqa_form">write<span class="sound_only"> 새 창</span></a>
    <a href="<?php echo $itemqa_list; ?>" id="itemqa_list" class="btn01">list</a>
</div>
