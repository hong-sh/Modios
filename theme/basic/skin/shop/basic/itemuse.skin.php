...
<div id="sit_use_wbtn">
    <a href="<?php echo $itemuse_form; ?>" class="btn02 itemuse_form">write<span class="sound_only"> 새 창</span></a>
    <a href="<?php echo $itemuse_list; ?>" class="btn01 itemuse_list">list</a>
</div>
