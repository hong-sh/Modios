...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="reg_mb_password">pass<strong class="sound_only">필수</strong></label></th>
        ...
        <tr>
            <th scope="row"><label for="reg_mb_password_re">pass check<strong class="sound_only">필수</strong></label></th>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <tr>
            <th scope="row"><label for="reg_mb_name">name<strong class="sound_only">필수</strong></label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="reg_mb_hp">phone<?php if ($config['cf_req_hp']) { ?><strong class="sound_only">필수</strong><?php } ?></label></th>
            <td>
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label for="reg_mb_mailling">E-mail service</label></th>
            <td>
        ...
        <tr>
            <th scope="row"><label for="reg_mb_sms">SMS service</label></th>
            <td>
