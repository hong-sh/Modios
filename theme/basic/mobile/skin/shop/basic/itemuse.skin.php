...
<div id="sit_use_wbtn">
    <a href="<?php echo $itemuse_form; ?>" class="qa_wr itemuse_form " onclick="return false;">Write review<span class="sound_only"> 새 창</span></a>
	<!-- <a href="<?php //echo $itemuse_list; ?>" id="itemuse_list" class="btn01">More+</a>
	 -->
</div>
