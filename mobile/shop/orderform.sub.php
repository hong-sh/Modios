...
?>
    ...
    <ul class="sod_list">
        ...
        <li class="sod_li">
            ...
            <div class="li_prqty">
                ...
                <span class="prqty_qty li_prqty_sp"><span>amount </span><?php echo number_format($sum['qty']); ?></span>
                <span class="prqty_sc li_prqty_sp"><span>delivery </span><?php echo $ct_send_cost; ?></span>
            </div>
            <div class="li_total">
                <span class="total_price total_span"><span>total </span><strong><?php echo number_format($sell_price); ?></strong></span>
                <span class="total_point total_span"><span>point </span><strong><?php echo number_format($sum['point']); ?></strong></span>
            </div>
    ...
    <dl id="sod_bsk_tot">
        ...
        <dd class="sod_bsk_coupon"><strong id="ct_tot_coupon">0 won</strong></dd>
        <?php } ?>
        <dt class="sod_bsk_dvr">delivery</dt>
        <dd class="sod_bsk_dvr"><strong><?php echo number_format($send_cost); ?> won</strong></dd>
        <dt class="sod_bsk_cnt">total</dt>
        <dd class="sod_bsk_cnt">
            <?php $tot_price = $tot_sell_price + $send_cost; // 총계 = 주문상품금액합계 + 배송비 ?>
            <strong id="ct_tot_price"><?php echo number_format($tot_price); ?> won</strong>
        </dd>
