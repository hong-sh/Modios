...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
        <h2>회원정보 개요</h2>
        <ul>
            <li  class="my_cou">coupon<a href="<?php echo G5_SHOP_URL; ?>/coupon.php" target="_blank" class="win_coupon"><?php echo number_format($cp_count); ?></a></li>
            <li class="my_point">point
